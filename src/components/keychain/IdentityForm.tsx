...
export function IdentityForm({ initial, onSubmit, onClose, onDelete, flushRef, vaults, canEdit, onMoveToVault, onCopyToVault }: IdentityFormProps) {
  ...
  const { schedule, markDirty, flushAndClose, flush, saveState } = useAutosave({
    onSave: () => {
