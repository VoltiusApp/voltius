...
export function HostStackMenu({ members, labels, shownId, activeSessionId, anchorRef, open, onClose, hoverBind, onHoldChange }: {
  ...
  return (
    <PickerSurface open={open} onClose={onClose} anchorRef={anchorRef} width="content" minWidth="16rem" gap={0} glass>
      <div {...hoverBind} data-testid="stack-menu-surface" className="-m-1.5 p-1.5">
