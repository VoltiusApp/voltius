...
// Dedicated file: the seeded manifest here has no `version` field at all (undefined),
...
const SEEDED_MANIFEST = { id: "plugin-docker", name: "Docker", permissions: ["docker:read"] };
...
test("missing seeded version (undefined): left alone rather than defaulting to supersede", async () => {
