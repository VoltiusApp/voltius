...
// Dedicated file: the seeded manifest here has a non-string `version` (a number),
...
const SEEDED_MANIFEST = { id: "plugin-docker", name: "Docker", version: 3, permissions: ["docker:read"] };
...
test("non-string seeded version (number): left alone rather than defaulting to supersede", async () => {
